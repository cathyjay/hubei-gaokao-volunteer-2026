...
```text
2026 招生计划全量 OCR 明细底座已生成，候选V2逐专业明细复核种子、全量质量分层队列、逐专业明细质量工作台和底座机器审计表已生成
```
...
| 时间 | 目标 | 产物 |
| --- | --- | --- |
| 2026-06-27 | 完成全量 OCR 明细底座、候选复核工作台、偏好专业和硬风险队列、候选V2逐专业明细种子、升级工作台、全量质量分层、逐专业质量工作台和底座机器审计；启动重点组人工复核 | 全量 OCR 招生明细、候选池复核工作台、优先复核队列、候选V2逐专业明细、升级闸门表、质量分层队列、逐专业明细质量工作台、底座审计表 |
