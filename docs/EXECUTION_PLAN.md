...
```text
2026 招生计划全量 OCR 明细底座已生成，候选V2逐专业明细复核种子、全量质量分层队列、逐专业明细质量工作台、底座机器审计表、候选V2证据总账、240 页公开页级 manifest、家庭底线筛选表、候选V3复核入口表、B0/B1 原页核验包和 B0/B1 官方交叉校验三表已生成
```
...
- 已生成 B0/B1 官方交叉校验三表：学校官方来源队列覆盖 36 所学校，组级官方交叉校验队列覆盖 49 个专业组，逐专业官方交叉校验队列覆盖 324 个专业任务；三表全部保持 `最终可用=false`、`可进入下一阶段=false`，用于补齐 PDF 原页、湖北官方系统/省招办、高校官网/章程、家庭接受度和调剂结论。
...
- B0/B1 官方交叉校验三表尚未完成闭环确认；当前官网来源状态只是补源线索，不能理解为“官方核验已完成”。
...
B0/B1 核验包和官方交叉校验三表都是复核工作台，不是可填报清单；包内所有组和专业仍必须保持不可进入最终表，直到原页、官方系统、章程、家庭接受度和调剂结论全部补齐。
...
| 时间 | 目标 | 产物 |
| --- | --- | --- |
| 2026-06-27 | 完成全量 OCR 明细底座、候选复核工作台、偏好专业和硬风险队列、候选V2逐专业明细种子、升级工作台、全量质量分层、逐专业质量工作台、底座机器审计、候选证据总账、页级 manifest、家庭底线筛选表、候选V3复核入口、B0/B1 原页核验包和 B0/B1 官方交叉校验三表；启动重点组人工复核 | 全量 OCR 招生明细、候选池复核工作台、优先复核队列、候选V2逐专业明细、升级闸门表、质量分层队列、逐专业明细质量工作台、底座审计表、候选字段复核总账、三方证据矩阵、页级 manifest、家庭底线筛选表、候选V3复核入口、B0/B1 核验包、B0/B1 官方交叉校验学校/组级/逐专业队列 |
