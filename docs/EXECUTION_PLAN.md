...
```text
2026 招生计划全量 OCR 明细底座已生成，候选V2逐专业明细复核种子、全量质量分层队列、逐专业明细质量工作台、底座机器审计表、候选V2证据总账、240 页公开页级 manifest、家庭底线筛选表、候选V3复核入口表和 B0/B1 原页核验包已生成
```
...
B0/B1 核验包是复核工作台，不是可填报清单；包内所有组和专业仍必须保持不可进入最终表，直到原页、官方系统、章程、家庭接受度和调剂结论全部补齐。
...
| 时间 | 目标 | 产物 |
| --- | --- | --- |
| 2026-06-27 | 完成全量 OCR 明细底座、候选复核工作台、偏好专业和硬风险队列、候选V2逐专业明细种子、升级工作台、全量质量分层、逐专业质量工作台、底座机器审计、候选证据总账、页级 manifest、家庭底线筛选表、候选V3复核入口和 B0/B1 原页核验包；启动重点组人工复核 | 全量 OCR 招生明细、候选池复核工作台、优先复核队列、候选V2逐专业明细、升级闸门表、质量分层队列、逐专业明细质量工作台、底座审计表、候选字段复核总账、三方证据矩阵、页级 manifest、家庭底线筛选表、候选V3复核入口、B0/B1 核验包 |
