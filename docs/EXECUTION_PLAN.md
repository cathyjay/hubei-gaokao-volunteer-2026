...
- 已生成 `data/working/issue19-candidate-v3-b0-b1-admission-detail-evidence-ledger.csv`：覆盖 324 条逐专业招生明细，已标准化留存官网/API/HTML/XLSX/PDF/图片抽取证据 367 条；当前 124 条专业名匹配，47 条计划数与 OCR 一致，52 条为 OCR 缺失但官网可补，25 条计划数存在差异。
- 已生成 B0/B1 保真复核队列：25 条计划数冲突、9 条专业未匹配、21 所学校补源缺口；其中 8 所是 P0 待补官方计划源，13 所是已有官网线索但尚未结构化到逐专业证据。
